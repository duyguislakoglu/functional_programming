...
(define (populate-players rooms)
  ...
  (create-autonomous-player 'lambda-man (pick-random rooms)
			    3 3)
;(define (violent-players rooms)
;   (make-violent-person 'derya (pick-random rooms) 2 2 1)
;   (make-violent-person 'deniz (pick-random rooms) 2 3 2)
;  (make-violent-person 'huriye (pick-random rooms) 2 1 0.3)
;  (make-violent-person 'aykut (pick-random rooms) 1 3 1))

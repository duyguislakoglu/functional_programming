...
;Unit-Interval = {x: Number | 0 <= x <= 1}
;Curve = Unit-interval --> Point
  	  	   	   
;;SOME CURVES  	  	   	   
;; note that a curve is a procedure that takes a value in the
;; unit interval, and returns a point
...
;;; TRANSLATE is of type (Number, Number --> Curve-Transform)
...
;;; ROTATE-AROUND-ORIGIN is of type (Number --> Curve-Transform)
...
;;; It is of type (Number,Number,Number,Number --> Curve-Transform).
...
;;; GOSPER-CURVE is of type (Number --> Curve)
...
;;; PARAM-GOSPER is of type ((Number,(Int --> Number)) --> Curve)
